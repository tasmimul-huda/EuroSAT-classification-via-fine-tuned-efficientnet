...
class AugmentedEfficientNet:
    ...
    def __init__(self, input_shape, num_classes):
        ...
        self.base_model = tf.keras.applications.efficientnet.EfficientNetB0(input_shape=self.input_shape, include_top=False, weights='imagenet')
...
#         base_model = tf.keras.applications.efficientnet.EfficientNetB0(input_shape=self.input_shape, include_top=False, weights='imagenet')
        ...
        for layer in self.base_model.layers[:20]:  #-20
